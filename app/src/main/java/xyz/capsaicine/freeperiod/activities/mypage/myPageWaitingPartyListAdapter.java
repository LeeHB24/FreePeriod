...
public class myPageWaitingPartyListAdapter extends RecyclerView.Adapter<RecyclerPartyCardViewHolder>{
    ...
    public myPageWaitingPartyListAdapter(ArrayList listParty, Context activityContext){
    ...
    public myPageWaitingPartyListAdapter(ArrayList listParty, Context context, Interface_myPagePartyListClick mListener) {
        this.listParty = listParty;
    ...
    public void onBindViewHolder(RecyclerPartyCardViewHolder holder, final int position){
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mListener!=null){
                    mListener.onWaitingPartyClick(view, position);
                }
            }
        });
    }
