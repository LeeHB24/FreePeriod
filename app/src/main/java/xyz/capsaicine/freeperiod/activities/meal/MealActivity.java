...
public class MealActivity extends PivotActivity implements Button.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setPivotActivity(MealActivity.this, navBottom);
        ...
        btnCreateParty = findViewById(R.id.btn_create_meal_party);
    ...
    protected void onResume() {
        ...
        if(!partyList.equals(DB.getInstance().getRecruitMealPartyList())) {
            partyList = DB.getInstance().getRecruitMealPartyList();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_create_meal_party:
    ...
    private void moveToActivity(Class nextActivityClass){
        Intent intent = new Intent(MealActivity.this, nextActivityClass);
        intent.putExtra("partyType", Party.Type.Meal);
